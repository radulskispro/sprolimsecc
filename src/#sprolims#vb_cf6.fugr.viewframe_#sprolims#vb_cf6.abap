*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/SPROLIMS/VB_CF6
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/SPROLIMS/VB_CF6    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CF6'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /SPROLIMS/VB_CF6_EXTRACT
TOTAL = /SPROLIMS/VB_CF6_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CF6'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/SPROLIMS/VB_CF6-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SPROLIMS/VB_CF6_EXTRACT
TOTAL = /SPROLIMS/VB_CF6_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/SPROLIMS/VB_CF6-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CF6'
...
TOTAL = /SPROLIMS/VB_CF6_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/SPROLIMS/VB_CF6-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/SPROLIMS/VB_CF6-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CF6'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/SPROLIMS/VB_CF6-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SPROLIMS/VB_CF6_EXTRACT
TOTAL = /SPROLIMS/VB_CF6_TOTAL
