*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/SPROLIMS/VDC
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/SPROLIMS/VDC       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VDC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /SPROLIMS/VDC_EXTRACT
TOTAL = /SPROLIMS/VDC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VDC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/SPROLIMS/VDC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SPROLIMS/VDC_EXTRACT
TOTAL = /SPROLIMS/VDC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/SPROLIMS/VDC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VDC'
...
TOTAL = /SPROLIMS/VDC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/SPROLIMS/VDC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/SPROLIMS/VDC-UPD_FLAG NE SPACE.
