*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/SPROLIMS/VB_CF4
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/SPROLIMS/VB_CF4    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CF4'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /SPROLIMS/VB_CF4_EXTRACT
TOTAL = /SPROLIMS/VB_CF4_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CF4'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/SPROLIMS/VB_CF4-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SPROLIMS/VB_CF4_EXTRACT
TOTAL = /SPROLIMS/VB_CF4_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/SPROLIMS/VB_CF4-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CF4'
...
TOTAL = /SPROLIMS/VB_CF4_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/SPROLIMS/VB_CF4-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/SPROLIMS/VB_CF4-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CF4'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/SPROLIMS/VB_CF4-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SPROLIMS/VB_CF4_EXTRACT
TOTAL = /SPROLIMS/VB_CF4_TOTAL
