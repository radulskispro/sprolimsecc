*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/SPROLIMS/V_USER
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/SPROLIMS/V_USER    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/SPROLIMS/V_USER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /SPROLIMS/V_USER_EXTRACT
TOTAL = /SPROLIMS/V_USER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/SPROLIMS/V_USER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/SPROLIMS/V_USER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SPROLIMS/V_USER_EXTRACT
TOTAL = /SPROLIMS/V_USER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/SPROLIMS/V_USER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/SPROLIMS/V_USER'
...
TOTAL = /SPROLIMS/V_USER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/SPROLIMS/V_USER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/SPROLIMS/V_USER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/SPROLIMS/V_USER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/SPROLIMS/V_USER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SPROLIMS/V_USER_EXTRACT
TOTAL = /SPROLIMS/V_USER_TOTAL
