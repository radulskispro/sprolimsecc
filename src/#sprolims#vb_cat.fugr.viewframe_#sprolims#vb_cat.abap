*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/SPROLIMS/VB_CAT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/SPROLIMS/VB_CAT    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CAT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /SPROLIMS/VB_CAT_EXTRACT
TOTAL = /SPROLIMS/VB_CAT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CAT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/SPROLIMS/VB_CAT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SPROLIMS/VB_CAT_EXTRACT
TOTAL = /SPROLIMS/VB_CAT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/SPROLIMS/VB_CAT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CAT'
...
TOTAL = /SPROLIMS/VB_CAT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/SPROLIMS/VB_CAT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/SPROLIMS/VB_CAT-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_/SPROLIMS/VB_CAT'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_/SPROLIMS/VB_CAT-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SPROLIMS/VB_CAT_EXTRACT
TOTAL = /SPROLIMS/VB_CAT_TOTAL
